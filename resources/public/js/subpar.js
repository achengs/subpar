(function() {
    ...
    CodeMirror.keyMap.subpar = {
        "Backspace"      : function(cm) {backwardDelete(cm)},
        "Delete"         : function(cm) {forwardDelete(cm)},
        "Ctrl-D"         : function(cm) {forwardDelete(cm)},

        "Shift-9"        : function(cm) {openExpression(cm,"()")},
        "["              : function(cm) {openExpression(cm,"[]")},
        "Shift-["        : function(cm) {openExpression(cm,"{}")},

        "Shift-0"        : function(cm) {closeExpression(cm)},
        "]"              : function(cm) {closeExpression(cm)},
        "Shift-]"        : function(cm) {closeExpression(cm)},

        "Shift-'"        : function(cm) {doubleQuote(cm)},

        "Ctrl-Alt-F"     : function(cm) {forward(cm)},
        "Ctrl-Alt-B"     : function(cm) {backward(cm)},
        "Ctrl-Alt-U"     : function(cm) {backwardUp(cm)},
        "Ctrl-Alt-D"     : function(cm) {forwardDown(cm)},
        "Ctrl-Alt-P"     : function(cm) {backwardDown(cm)},
        "Ctrl-Alt-N"     : function(cm) {forwardUp(cm)},// doesn't work for chrome on windows

        "Shift-Ctrl-["   : function(cm) {backwardBarf(cm)},
        "Ctrl-Alt-Right" : function(cm) {backwardBarf(cm)},

        "Shift-Ctrl-]"   : function(cm) {forwardBarf(cm)},
        "Ctrl-Left"      : function(cm) {forwardBarf(cm)},

        "Shift-Ctrl-9"   : function(cm) {backwardSlurp(cm)},
        "Ctrl-Alt-Left"  : function(cm) {backwardSlurp(cm)},

        "Shift-Ctrl-0"   : function(cm) {forwardSlurp(cm)},// todo key combination didn't work in chrome on windows
        "Ctrl-Right"     : function(cm) {forwardSlurp(cm)},

        //todo add padding space if necessary for all splices
        "Alt-Up"         : function(cm) {spliceDeleteBackward(cm)},
        "Alt-Down"       : function(cm) {spliceDeleteForward(cm)},
        "Alt-S"          : function(cm) {splice(cm)},
        //todo wrap expression in round, square, curly.
        "Ctrl-Alt-\\"    : function(cm) {indentSelection(cm)},
